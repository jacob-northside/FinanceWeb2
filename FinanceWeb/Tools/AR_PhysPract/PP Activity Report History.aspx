<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PP Activity Report History.aspx.vb" Inherits="FinanceWeb.PP_Activity_Report_History" %>
...
<head runat="server">
    <title>PP AR Activity Report - Row History</title>
</head>
<body>
 ...
 {        display: none;    
        ...
        <cc1:TabContainer ID="MDPOSMappingTabs" runat="server"
            ...
            <cc1:TabPanel runat="server" HeaderText="PP AR Activity Report Attachments" ID="tpMDPOSUnmapped">
                <ContentTemplate>

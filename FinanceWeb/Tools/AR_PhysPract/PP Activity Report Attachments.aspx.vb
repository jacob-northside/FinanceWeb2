...
Public Class PP_Activity_Report_Attachments
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Else
                ...
                'Dim adminsql As String = "SELECT count(*) FROM DWH.AR_PP.Activity_Users where UserLogin = '" & _
            ...
            If Request.QueryString("Detail_ID") IsNot Nothing Then
                ...
                Dim sql As String = "select ad.Facility, ad.CashCategory, ad.DetailStatus, ar.DepositDate, ad.Cash_Received " & _
                    "from DWH.AR_PP.ActivityReport ar join DWH.AR_PP.ActivityReport_Detail ad on ar.ActivityID = ad.ActivityID and ad.active = 1" & _
                    "where ar.Active = 1 and ad.ActivityID = '" & Replace(Request.QueryString("Detail_ID"), "'", "''") & "' and not exists (select * from DWH.AR_PP.ActivityReport_Detail ad2 " & _
                        "where ad2.Active = 1 and ad2.ActivityID = ad.ActivityID and (ad2.ActivityDate > ad.ActivityDate or (ad2.ActivityDate = ad.ActivityDate and ad2.ModifiedDate > ad.ModifiedDate))) "
    ...
    Private Sub BindGrid()
        ...
        '    ", af.* " & _
        '    "from DWH.AR_PP.Activity_Detail ad " & _
        '    "join DWH.AR_PP.Activity_Detail_AttachedFiles af on ad.ActivityID = af.ActivityID " & _
        '    "where ad.Detail_ID = '" & Replace(Request.QueryString("Detail_ID"), "'", "''") & "'"
    ...
    "join DWH.AR_PP.ActivityReport_Detail ad on ar.ActivityID = ad.ActivityID and ad.active = 1" & _
    "join DWH.AR_PP.ActivityReport_AttachedFiles af on ad.ActivityID = af.ActivityID " & _
    "where ar.Active = 1 and ad.ActivityID = '" & Replace(Request.QueryString("Detail_ID"), "'", "''") & "' and not exists (select * from DWH.AR_PP.ActivityReport_Detail ad2 " & _
        "where ad2.Active = 1 and ad2.ActivityID = ad.ActivityID and (ad2.ActivityDate > ad.ActivityDate or (ad2.ActivityDate = ad.ActivityDate and ad2.ModifiedDate > ad.ModifiedDate))) "
            ...
            Using fs As Stream = fileInput.PostedFile.InputStream
                ...
                Using br As New BinaryReader(fs)
                    ...
                    Using conn As New System.Data.SqlClient.SqlConnection(ConfigurationManager.ConnectionStrings("PRDconn").ConnectionString)
                        ...
                        Dim query As String = "INSERT INTO DWH.AR_PP.ActivityReport_AttachedFiles (ActivityID, FileName, ContentType, Content, UserID, DateAdded, Active) VALUES " & _
    ...
    Private Sub btnUpload_Click(sender As Object, e As EventArgs) Handles btnUpload.Click
        ...
        ExecuteSql("update af set af.ActivityDate = ev.Value from DWH.AR_PP.ActivityReport_AttachedFiles af " & _
            "join DWH.AR_PP.ActivityReport_ExtraValues ev on ev.Active = 1 and ev.Description = 'RunDate'  " & _
    ...
    Protected Sub DownloadFile(sender As Object, e As EventArgs)
        ...
        Using conn As New System.Data.SqlClient.SqlConnection(ConfigurationManager.ConnectionStrings("PRDconn").ConnectionString)
            ...
            cmd.CommandText = "select FileName, Content, ContentType from DWH.AR_PP.ActivityReport_AttachedFiles where [AttachID]=@Id"

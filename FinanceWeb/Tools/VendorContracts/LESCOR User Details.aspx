<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="LESCOR User Details.aspx.vb" Inherits="FinanceWeb.LESCOR_User_Details" %>
                            ...
                            User Name:
                                ...
                                <asp:Panel runat="server" ID="ScrollPanel" ScrollBars="Auto">
                                    <asp:GridView ID="gvDepartments" runat="server" AutoGenerateColumns="false" BackColor="#CBE3FB" AllowPaging="false" CellSpacing="0"
                                        HeaderStyle-Font-Size="Medium" AllowSorting="false" Font-Size="Small" Width="100%" DataKeyNames="DepartmentID, RoleID"

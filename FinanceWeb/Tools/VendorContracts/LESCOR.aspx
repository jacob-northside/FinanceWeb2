<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="LESCOR.aspx.vb" Inherits="FinanceWeb.LESCOR1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="FeaturedContent" runat="server">
    ...
    <script>
        ...
        function open_win() {
            ...
            var url = "https://financeweb.northside.local/Tools/VendorContracts/Contract Management Policy.aspx?Guide=1";
            myWindow = window.open(url, 'LESCOR Guide', 'height=900,width=1120, scrollbars, resizable');
            myWindow.focus();
    ...
    <asp:UpdatePanel runat="server" ID="upWholeThing">
        <ContentTemplate>
            ...
            <cc1:TabContainer ID="VendorContracts" runat="server"
                ...
                <cc1:TabPanel runat="server" HeaderText="Welcome" ID="tpOpenVendor">
                    <ContentTemplate>
                       ...
                       <ContentTemplate>--%>
                        ...
                        <asp:Panel runat="server" BackColor="#CBE3FB" BorderColor="#003060" BorderStyle="Solid" BorderWidth="1px" Width="1145px">
                            <asp:Table runat="server">
                                ...
                                <asp:TableRow>
                                    <asp:TableCell></asp:TableCell>
                                    <asp:TableCell>To view the LESCOR User Guide, please click <asp:LinkButton runat="server" Text="here" OnClientClick="open_win()" ></asp:LinkButton>. </asp:TableCell>
                                </asp:TableRow>
                                <asp:TableRow>
                                    <asp:TableCell Height="10px"></asp:TableCell>
                                </asp:TableRow>
...
<asp:LinkButton OnClientClick="open_win()" runat="server" Font-Italic="true" Font-Size="Small">LESCOR FAQ</asp:LinkButton>
                ...
                <cc1:TabPanel runat="server" HeaderText="Submit Vendor Contract" ID="tpSubmitContract">
                    <ContentTemplate>
                                                    ...
                                                    <asp:Table runat="server" Width="100%" CellPadding="0" CellSpacing="0">
                                                        ...
                                                        <asp:TableRow ID="trResponses">
                                                            ...
                                                            <asp:TableCell VerticalAlign="Top" >
                                                                <asp:Label runat="server" ID="lblResponseAsk" Visible="false" Font-Bold="true" ForeColor="Red" Text='<%# Bind("ResponseQuestion")%>'></asp:Label>
                                                            </asp:TableCell>
                                                            <asp:TableCell></asp:TableCell>
                    ...
                    <ContentTemplate>
                                ...
                                <asp:TableCell VerticalAlign="Top">
                                    <asp:Panel runat="server" BackColor="#CBE3FB" BorderColor="#003060" BorderStyle="Solid" BorderWidth="1px">
                                        <asp:Table runat="server" Width="1145px" CellPadding="0" CellSpacing="0">
                                            <asp:TableRow>
                                                <asp:TableCell Width="1px" RowSpan="5"></asp:TableCell>
                                                <asp:TableCell ColumnSpan="2" HorizontalAlign="left" VerticalAlign="Middle">
                                                    <asp:CheckBox BorderColor="#003060" BorderWidth="1" Width="160px" Font-Bold="true" Height="20px" BackColor="#6da9e3" Font-Size="X-Small" runat="server" ID="cb_SelectAll" AutoPostBack="true" Text="Select All" />
                                                </asp:TableCell>
                                                <asp:TableCell ColumnSpan="2" RowSpan="2" HorizontalAlign="Left">
                                                    Submission Date Between:                                                              
                       
                                                </asp:TableCell>
                                                <asp:TableCell ColumnSpan="4" RowSpan="2">
                                            ...
                                            <asp:TableRow VerticalAlign="Top">
                                                ...
                                                <asp:TableCell Width="150px" HorizontalAlign="Left" VerticalAlign="Middle" RowSpan="4">                                                    
                                                    ...
                                                    <asp:CheckBox BorderColor="#003060" BorderWidth="1" Width="160px" Height="20px" BackColor="#ffffaa" Font-Size="X-Small" runat="server" ID="cbLegalShowQueue" Text="Pending Legal Approval" Checked="true" />
                                                    <asp:CheckBox BorderColor="#003060" BorderWidth="1" Width="160px" Height="20px" BackColor="#bbffbb" Font-Size="X-Small" runat="server" ID="cbLegalInProgress" Text="In Progress" Checked="true" />
                                                    <asp:CheckBox BorderColor="#003060" BorderWidth="1" Width="160px" Height="20px" BackColor="#c6BCe7" Font-Size="X-Small" runat="server" ID="cbLegalOnHold" Text="On Hold" Checked="false" />
                                                    <asp:CheckBox BorderColor="#003060" BorderWidth="1" Width="160px" Height="20px" BackColor="#ffcae4" Font-Size="X-Small" runat="server" ID="cbLegalNoResponse" Text="No Response" Checked="false" />                                                    
                                                    <asp:CheckBox BorderColor="#003060" BorderWidth="1" Width="160px" Height="20px" BackColor="#ffffff" Font-Size="X-Small" runat="server" ID="cbLegalShowRejected" Text="Deleted" Checked="false" />
                                                                                                      
                                                </asp:TableCell>
                                                <asp:TableCell HorizontalAlign="Left" VerticalAlign="Middle" RowSpan="4" Width="150px" ID="tcLegalOptions">
                                                    ...
                                                    <asp:CheckBox BorderColor="#003060" BorderWidth="1" Width="160px" Height="20px" BackColor="#e4f7ae" Font-Size="X-Small" runat="server" ID="cbLegalShowApproved" Text="Approved" Checked="false" />
                                                    <asp:CheckBox BorderColor="#003060" BorderWidth="1" Width="160px" Height="20px" BackColor="#ffd7ff" Font-Size="X-Small" runat="server" ID="cbLegalShowClosed" Text="Closed" Checked="false" /><br />
                                                    <asp:CheckBox BorderColor="#003060" BorderWidth="1" Width="160px" Height="20px" BackColor="#c4ffff" Font-Size="X-Small" runat="server" ID="cbLegalLoadedinMeditract" Text="Loaded" Checked="false" />
                                    ...
                                    <asp:GridView Width="1145px" ID="gvLegalResults" runat="server" HeaderStyle-BackColor="#6da9e3" HeaderStyle-BorderColor="#003060"
                                        ...
                                        <Columns>
                                           ...
                                           SortExpression="DepartmentNo"></asp:BoundField>--%>
                                            ...
                                            <asp:BoundField DataField="OverallStatus" HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hiddenlabel"
                                                SortExpression="OverallStatus"></asp:BoundField>
                                        </Columns>
                                    ...
                                    <asp:Panel runat="server" ID="pnlLegalUpdates" Visible="false">
                                        ...
                                        <asp:GridView runat="server" ShowHeaderWhenEmpty="false" ID="gvLegalApproval" AutoGenerateColumns="false" Width="1145px"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        <asp:Button runat="server" ID="btnRemove" Text="Reset" Height="22px" Width="70px"
                                                            CssClass='<%# Bind("BtnCss")%>' CommandName="ResetRejection" CommandArgument='<%# Bind("UserLogin")%>' />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
                                        ...
                                        <asp:Panel runat="server" BackColor="#CBE3FB" BorderColor="#003060" BorderStyle="Solid" BorderWidth="1px" Width="1145px">
                                            <asp:Table runat="server">
                                                <asp:TableRow>
                                                    ...
                                                    <asp:TableCell>
                                                        <asp:TextBox runat="server" Enabled="false" ID="txtMeditractNumber"></asp:TextBox>
                                                    </asp:TableCell>
                                                </asp:TableRow>
                                                <asp:TableRow>
                                                    <asp:TableCell></asp:TableCell>
                        ...
                        Requestor comments:
                                        ...
                                        <asp:Panel ID="pnlLegalComments" runat="server" BackColor="#CBE3FB" BorderColor="#003060" BorderStyle="Solid" BorderWidth="1px" Width="1145px">
                                            <asp:Table runat="server" Width="100%">
                                                <asp:TableRow>
                                                    <asp:TableCell Width="5px" RowSpan="10"></asp:TableCell>
                                                    <asp:TableCell HorizontalAlign="Left" VerticalAlign="Top" Width="150px">
                                                      Comments:
                                                    </asp:TableCell>
                                                    <asp:TableCell ColumnSpan="5" HorizontalAlign="Left" VerticalAlign="Top">                                                        
                                                ...
                                                <asp:TableRow>
                                                    ...
                                                    <asp:TableCell ColumnSpan="5" HorizontalAlign="Left" VerticalAlign="Top" Width="610px">
                                                   ...
                                                   <asp:CheckBox runat="server" ID="cbHideLegalComments" Text="Legal Users Only" Checked="true" Font-Size="X-Small" />
                                                    ...
                                                    <asp:TableCell VerticalAlign="Middle" HorizontalAlign="Left" Width="150px">
                                                        <asp:Button runat="server" ID="btn_LegalAddComment" Text="Add Comment" />
                                ...
                                <asp:TableRow>
                                    ...
                                    <asp:TableCell>
                                        <asp:DropDownList runat="server" ID="ddlAdminFacility" Width="153px">
                                            ...
                                            <asp:ListItem Text="Gwinnett" Value="30" />
                                            <asp:ListItem Text="Duluth" Value="40" />
                                        </asp:DropDownList>
                                    </asp:TableCell>
                                    <asp:TableCell></asp:TableCell>
                                </asp:TableRow>
                                        ...
                                        <asp:TableCell>
                                            ...
                                            <asp:GridView ID="gvAdminUsers" runat="server"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Email" SortExpression="UserEmailAddress">
                                                        <ItemTemplate>
                                                            <asp:Panel CssClass="paneltest" Width="95%" runat="server">
                                                                <asp:Label ID="lblEmail" runat="server" Text='<%# Bind("UserEmailAddress")%>' Visible="true"></asp:Label>
                                                            </asp:Panel>
                                                            <asp:TextBox runat="server" ID="txtEmail" Text='<%# Bind("UserEmailAddress")%>' Visible="false"></asp:TextBox>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>

<%@ Page Language="vb" MaintainScrollPositionOnPostback="true" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Activity_Report.aspx.vb" Inherits="FinanceWeb.Activity_Report" %>
 ...
 z-index: 100003;
    ...
    <script>
        ...
        function open_ssrs() {
            ...
            var url = "https://powerbi.northside.local/reports/report/BIDS/Accounting%20-%20Operational/Accounts%20Receivable/AR/AR%20Activity%20Sheet%20Monthly%20Summary";
        ...
        <cc1:TabPanel runat="server" HeaderText="Activity Report Data Entry" ID="tpARData">
            <ContentTemplate>
                        ...
                        <asp:Label runat="server" ID="Developer"></asp:Label>
                            <asp:Label runat="server" ID="DSFilter"></asp:Label>
           ...
           <asp:TemplateField HeaderText="DetailID" Visible=false  >
                ...
                <ItemTemplate>
                    <asp:Label ID="lblARBase_ID" runat="server"   Text='<%# Eval("Base_ID")%>'></asp:Label>
                                        ...
                                        <asp:TemplateField HeaderText="Assigned To" SortExpression="AssignedDisplay">
                                            <ItemTemplate>
                               ...
                               <asp:TemplateField HeaderText="Deposit Date" ItemStyle-Width="100" SortExpression="sortDepositDate">
                                 ...
                                 <asp:TemplateField HeaderText="Facility" ItemStyle-Width="100" SortExpression="Facility">
                                        ...
                                        <asp:TemplateField HeaderText="# Patients" ItemStyle-Width="75" SortExpression="NoPatients" ItemStyle-CssClass="hidden" HeaderStyle-CssClass="hidden">
                                            <ItemTemplate>
                            ...
                            <asp:Table runat="server" Width="900px" Height="100%">
                                ...
                                <asp:TableRow>
                                    <asp:TableCell Width="10px"></asp:TableCell><asp:TableCell ColumnSpan="3" HorizontalAlign="Center" VerticalAlign="Middle" BackColor="#CBE3FB">
                                        ...
                                        Select User:
                                        <asp:DropDownList runat="server" ID="ddlNetRowUser" AutoPostBack="true"></asp:DropDownList><br />
                                        <asp:Panel runat="server" ScrollBars="Auto" Height="500px" Width="800px">
                                            <asp:GridView ID="gvNettingRows" runat="server" AutoGenerateColumns="False" Width="100%"
                                                DataKeyNames="ActivityID" HeaderStyle-HorizontalAlign="Right"
                                                BorderColor="#003060" BackColor="#CBE3FB" RowStyle-BorderColor="#003060" RowStyle-BorderWidth="1px"
                                                HeaderStyle-ForeColor="White" CellPadding="2" CellSpacing="2"
                                                HeaderStyle-Wrap="true" ForeColor="Black"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Assigned To" SortExpression="AssignedDisplay">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblARAssigned" runat="server" Text='<%# Eval("AssignedDisplay")%>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Bank Batch #"  SortExpression="BankBatchNumber">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblARBatchNo" runat="server" Text='<%# Eval("BankBatchNumber")%>'></asp:Label>
                                                    ...
                                                    <asp:TemplateField HeaderText="Cash Received" ItemStyle-Width="75" SortExpression="AbsReceived">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblARWF_Cash_Received" runat="server" Text='<%# Eval("Cash_Received", "{0:C}")%>'></asp:Label>

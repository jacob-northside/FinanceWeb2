<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="StarGLJEEntries.aspx.vb" Inherits="FinanceWeb.StarGLJEEntries" %>
                    ...
                    <asp:TableRow ID="TableRow3" runat="server">
                        ...
                        <asp:TableRow ID="TableRow7" runat="server">
                            <asp:TableCell ID="TableCell22" runat="server">
                                <asp:CheckBox ID="chbDuluth" runat="server" Font-Size="Small" Text="Duluth" />
                            </asp:TableCell>
                        ...
                        <asp:TableRow ID="TableRow8" runat="server">
                            <asp:TableCell ID="TableCell25" runat="server">
                                <asp:CheckBox ID="chbGwinnett" runat="server" Font-Size="Small" Text="Gwinnett" />
                            </asp:TableCell>
...
<asp:BoundField DataField="Text" HeaderText="Previous Cherokee Files" />       
 ...
 <asp:LinkButton ID="lnkCherokeeDownload" Text = "Download" CommandArgument = '<%# Eval("Value") %>' runat="server" OnClick = "DownloadFile"></asp:LinkButton>     
                       ...
                       <br />
                            <asp:LinkButton ID="lbDuluthDownloads" runat="server" Text="View Past Duluth Corrections"></asp:LinkButton>
                            <asp:Panel ID="Panel4" runat="server">
                                <asp:GridView ID="gvDuluthDownloads" runat="server" AutoGenerateColumns="false"
                                    EmptyDataText="No files uploaded" AllowSorting="True">
                                    <Columns>
                                        <asp:BoundField DataField="Text" HeaderText="Previous Duluth Files" />
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkDuluthDownload" Text="Download" CommandArgument='<%# Eval("Value") %>' runat="server" OnClick="DownloadFile"></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                            ...
                            <cc1:CollapsiblePanelExtender ID="CollapsiblePanelExtender3"
                                runat="server" Enabled="True" TargetControlID="Panel4" Collapsed="True"
                                CollapsedSize="0" AutoCollapse="False" ExpandControlID="lbDuluthDownloads"
                                CollapseControlID="lbDuluthDownloads" AutoExpand="False" ScrollContents="False"
                                TextLabelID="lbDuluthDownloads" CollapsedText="View Past Duluth Corrections..."
                                ExpandedText="Hide Corrections...." ImageControlID="Image1"></cc1:CollapsiblePanelExtender>
                            <br />
                            <asp:LinkButton ID="lbGwinnettDownloads" runat="server" Text="View Past Gwinnett Corrections"></asp:LinkButton>
                            <asp:Panel ID="Panel5" runat="server">
                                <asp:GridView ID="gvGwinnettDownloads" runat="server" AutoGenerateColumns="false"
                                    EmptyDataText="No files uploaded" AllowSorting="True">
                                    <Columns>
                                        <asp:BoundField DataField="Text" HeaderText="Previous Gwinnett Files" />
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkGwinnettDownload" Text="Download" CommandArgument='<%# Eval("Value") %>' runat="server" OnClick="DownloadFile"></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                            ...
                            <cc1:CollapsiblePanelExtender ID="CollapsiblePanelExtender4"
                                runat="server" Enabled="True" TargetControlID="Panel5" Collapsed="True"
                                CollapsedSize="0" AutoCollapse="False" ExpandControlID="lbGwinnettDownloads"
                                CollapseControlID="lbGwinnettDownloads" AutoExpand="False" ScrollContents="False"
                                TextLabelID="lbGwinnettDownloads" CollapsedText="View Past Gwinnett Corrections..."
                                ExpandedText="Hide Corrections...." ImageControlID="Image1"></cc1:CollapsiblePanelExtender>
                            <br />
                        </asp:TableCell>
               ...
               <asp:Panel ID="pnlExportHeader" runat="server" Visible="false">
                        ...
                        <asp:TableRow runat="server">
                            <asp:TableCell runat="server"></asp:TableCell><asp:TableCell runat="server">
                                <div id="Duluth" runat="server" style="padding-right: 10px;">
                                    <asp:GridView ID="gvDuluth" runat="server" AutoGenerateColumns="False"
                                        BackColor="White" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px"
                                        CellPadding="4" Font-Size="X-Small" ForeColor="Black"
                                        HeaderStyle-BackColor="#214B9A" HeaderStyle-ForeColor="#FFCBA5"
                                        HeaderStyle-HorizontalAlign="Left" HeaderStyle-Wrap="true">
                                    ...
                                    <asp:Button ID="btnGenerateDuluth" runat="server" Text="Finalize Duluth File and Export to Excel" Visible="false" />
                                    <asp:Button ID="btnExportDuluth" runat="server" Text="Finalize Duluth File and Generate Excel File" Visible="false" />
                                    <asp:Label ID="lblDuluthMessage" runat="server" ForeColor="Red" Visible="False"></asp:Label>
                                    <asp:HyperLink ID="hlDownloadDuluth" runat="server" Text="" Visible="false" Target="_blank"></asp:HyperLink>
                                    <br />
                                    <%--                       <asp:RadioButtonList ID="rdlDuluth" runat="server" RepeatDirection="Horizontal" Visible="false" Font-Size="Smaller">
                         <asp:ListItem  Value="xlsx">Excel 2007 or newer</asp:ListItem>
                        <asp:ListItem Selected="True" Value="xls">Excel 97 - 2003</asp:ListItem>
                        </asp:RadioButtonList>--%>
                                    <asp:Panel ID="pnlDuluthExportHeader" runat="server" Visible="false">
                                        <asp:Label ID="lblDHeader" runat="server" Font-Bold="True" Text="Hospital Journal Entry "></asp:Label>
                                        <br />
                                        <br />
                                        <asp:Label ID="lblDEntity" runat="server" Text="Entity:"></asp:Label>
                                        <br />
                                        <asp:Label ID="lblDDate" runat="server" Text="Date:"></asp:Label><br />
                                        <asp:Label ID="lblDPeriod" runat="server" Text="Period:"></asp:Label>
                                        <br />
                                        <asp:Label ID="lblDYear" runat="server" Text="Year:"></asp:Label><br />
                                        <asp:Label ID="lblDBatch" runat="server" Text="Batch:"></asp:Label><br />
                                        <asp:Label ID="lblDJERef" runat="server" Text="JE Ref#: "></asp:Label><br />
                                        <asp:Label ID="lblDJEJ" runat="server" Text="JE(J) or ACCR(A):"></asp:Label><br />
                                        <asp:Label ID="lblDRevers" runat="server" Text="Reversing:"></asp:Label><br />
                                        <br />
                                        <asp:Label ID="lblDDesc" runat="server" Text="Description: Clear suspense activity"></asp:Label>
                                    </asp:Panel>
                                </div>
                        ...
                        <asp:TableRow runat="server">
                            <asp:TableCell runat="server"></asp:TableCell><asp:TableCell runat="server">
                                <div id="Gwinnett" runat="server" style="padding-right: 10px;">
                                    <asp:GridView ID="gvGwinnett" runat="server" AutoGenerateColumns="False"
                                        BackColor="White" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px"
                                        CellPadding="4" Font-Size="X-Small" ForeColor="Black"
                                        HeaderStyle-BackColor="#214B9A" HeaderStyle-ForeColor="#FFCBA5"
                                        HeaderStyle-HorizontalAlign="Left" HeaderStyle-Wrap="true">
                                    ...
                                    <asp:Button ID="btnGenerateGwinnett" runat="server" Text="Finalize Gwinnett File and Export to Excel" Visible="false" />
                                    <asp:Button ID="btnExportGwinnett" runat="server" Text="Finalize Gwinnett File and Generate Excel File" Visible="false" />
                                    <asp:Label ID="lblGwinnettMessage" runat="server" ForeColor="Red" Visible="False"></asp:Label>
                                    <asp:HyperLink ID="hlDownloadGwinnett" runat="server" Text="" Visible="false" Target="_blank"></asp:HyperLink>
                                    <br />
                                    <%--                       <asp:RadioButtonList ID="rdlGwinnett" runat="server" RepeatDirection="Horizontal" Visible="false" Font-Size="Smaller">
                         <asp:ListItem  Value="xlsx">Excel 2007 or newer</asp:ListItem>
                        <asp:ListItem Selected="True" Value="xls">Excel 97 - 2003</asp:ListItem>
                        </asp:RadioButtonList>--%>
                                    <asp:Panel ID="pnlGwinnettExportHeader" runat="server" Visible="false">
                                        <asp:Label ID="Label16" runat="server" Font-Bold="True" Text="Hospital Journal Entry "></asp:Label>
                                        <br />
                                        <br />
                                        <asp:Label ID="Label17" runat="server" Text="Entity:"></asp:Label>
                                        <br />
                                        <asp:Label ID="Label18" runat="server" Text="Date:"></asp:Label><br />
                                        <asp:Label ID="Label19" runat="server" Text="Period:"></asp:Label>
                                        <br />
                                        <asp:Label ID="Label20" runat="server" Text="Year:"></asp:Label><br />
                                        <asp:Label ID="Label21" runat="server" Text="Batch:"></asp:Label><br />
                                        <asp:Label ID="Label22" runat="server" Text="JE Ref#: "></asp:Label><br />
                                        <asp:Label ID="Label23" runat="server" Text="JE(J) or ACCR(A):"></asp:Label><br />
                                        <asp:Label ID="Label24" runat="server" Text="Reversing:"></asp:Label><br />
                                        <br />
                                        <asp:Label ID="Label25" runat="server" Text="Description: Clear suspense activity"></asp:Label>
                                    </asp:Panel>
                                </div>
                    ...
                    </asp:Table></div><br /></asp:Panel></div></asp:Content>
<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Activity Report.aspx.vb" Inherits="FinanceWeb.Activity_Report1" %>
 ...
 z-index: 100003;
    ...
    <script>
        ...
        function open_win(id) {
            ...
            var url = "https://financeweb.northside.local/Tools/AR_GECC/AR GECC Attachments/?Detail_ID=" + id;
            myWindow = window.open(url, 'AR GECC Activity Report Attachments', 'height=700,width=620, scrollbars, resizable');
            myWindow.focus();
        ...
        function open_ssrs() {
            ...
            var url = "http://ssrs.northside.local/Reports/Pages/Report.aspx?ItemPath=%2fFinance%2fAccounting+-+Operational%2fAccounts+Receivable%2fAR+GECC%2fAR+GECC+Activity+Sheet+Monthly+Summary";
                        ...
                        <asp:Panel ID="Panel1" runat="server">
                         ...
                         Assigned User:
                                    ...
                                    <asp:TableCell Width="200px">
                                        <asp:DropDownList runat="server" ID="ddlARAssignedUser"></asp:DropDownList>
                                    </asp:TableCell>
                                    ...
                                    <asp:TableCell ColumnSpan="5" RowSpan="3">
                                        <asp:Table runat="server" HorizontalAlign="Center" CellPadding="0" CellSpacing="0">
                                            <asp:TableRow>
                                                ...
                                                <asp:TableCell VerticalAlign="Top">
                                                    <b>Facility:</b><br />
                                                    <asp:CheckBoxList Width="140px" runat="server" ID="cblARFacility"></asp:CheckBoxList>
                                                </asp:TableCell>
                                                <asp:TableCell VerticalAlign="Top">
                                                    <b>Show Rows with: </b>
                         ...
                         Activity Report For:
                                ...
                                <asp:TableRow>
                                    ...
                                    <asp:TableCell></asp:TableCell>
                                    <asp:TableCell>
                                        <asp:TextBox runat="server" ID="txtSrch"></asp:TextBox>
                                    </asp:TableCell>
                                </asp:TableRow>
                                <asp:TableRow>
                                ...
                                <asp:TableRow>
                                    <asp:TableCell HorizontalAlign="Center" ColumnSpan="10">
                                        <asp:Button runat="server" ID="btn_ActivityReportSearch" Text="Search" Width="200px" />
                                    </asp:TableCell>
                                </asp:TableRow>
                            </asp:Table>
                            <br />
                    ...
                    <asp:Label ID="lblARBase_ID" runat="server"   Text='<%# Eval("Base_ID")%>'></asp:Label>
                                        ...
                                        <asp:TemplateField HeaderText="Assigned To">
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="lblARAssignedUser" runat="server" Visible="false" Text='<%# Eval("AssignedDisplay")%>'></asp:Label>
                                        ...
                                        <asp:TemplateField HeaderText="Facility" ItemStyle-Width="100" SortExpression="Facility">
                                            <ItemTemplate>
                                                <asp:Label ID="lblARFacility" runat="server" Text='<%# Eval("Facility")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Batch #" ItemStyle-Width="75" SortExpression="STARBatchNumber">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Misc. Posted" ItemStyle-Width="75" SortExpression="MiscAmt">
                                            <ItemTemplate>
                                                ...
                                                <br />
                                                <asp:Label ID="lblARMiscPosted" Visible="true" runat="server" Text='<%# Eval("MiscAmt", "{0:0,0.00}")%>'></asp:Label>
                                        ...
                                        <asp:TemplateField HeaderText="Transfers" ItemStyle-Width="75" SortExpression="Transfer_Sum" Visible="false">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Attachments" ItemStyle-Width="75" SortExpression="Attachments">
                                            <ItemTemplate>
                                                ...
                                                <asp:ImageButton ID="imggreen" Visible="false" runat="server" ImageUrl="Images/ClipGreen.bmp" Width="11px" />
                            ...
                            <asp:Table runat="server" Width="100%">
                                <asp:TableRow>
                                    ...
                                    <asp:TableCell HorizontalAlign="Center">
                                        <asp:Button ID="btnNewCashJournal" UseSubmitBehavior="false" runat="server" Width="250px" Text="New Cash Journal" Font-Size="Large" />
                        ...
                        <asp:Panel ID="pnlUnresolvedRows" runat="server" Width="700px" BackColor="#6da9e3" BorderColor="#003060" BorderStyle="Solid" BorderWidth="1px">
                            <asp:Table runat="server" Width="100%" Height="100%">
                                <asp:TableRow>
                                    <asp:TableCell Height="20px">
                                        <asp:Label runat="server" Visible="false" ID="lblUnresolvedID"></asp:Label>
                                    </asp:TableCell>
                                </asp:TableRow>
                                <asp:TableRow>
                                    <asp:TableCell Width="10px"></asp:TableCell><asp:TableCell HorizontalAlign="Center" VerticalAlign="Middle" BackColor="#CBE3FB">
...
<%--                        <asp:Label ID="FakeTransferButton" runat="server" />
                        <asp:Panel ID="Panel3" runat="server" Width="450px" BackColor="#6da9e3" BorderColor="#003060" BorderStyle="Solid" BorderWidth="1px">
                            <asp:Table runat="server" Width="100%" Height="100%">
                                <asp:TableRow>
                                    <asp:TableCell Height="20px"></asp:TableCell>
                                </asp:TableRow>
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Transfer From">
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:DropDownList ID="ddlTFFAC" SelectedValue='<%# Eval("TFFAC")%>' Enabled="false" runat="server">
                                                            <asp:ListItem Text="Select Value" Value="null"></asp:ListItem>
                                                            <asp:ListItem Text="Atlanta" Value="A"></asp:ListItem>
                                                            <asp:ListItem Text="Cherokee" Value="C"></asp:ListItem>
                                                            <asp:ListItem Text="Duluth" Value="D"></asp:ListItem>
                                                            <asp:ListItem Text="Forsyth" Value="F"></asp:ListItem>
                                                            <asp:ListItem Text="Gwinnett" Value="L"></asp:ListItem>
                                                        </asp:DropDownList>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Transfer To">
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:DropDownList ID="ddlTTFAC" SelectedValue='<%# Eval("TTFAC")%>' runat="server">
                                                            <asp:ListItem Text="Select Value" Value="null"></asp:ListItem>
                                                            <asp:ListItem Text="Atlanta" Value="A"></asp:ListItem>
                                                            <asp:ListItem Text="Cherokee" Value="C"></asp:ListItem>
                                                            <asp:ListItem Text="Duluth" Value="D"></asp:ListItem>
                                                ...
                                                <asp:TemplateField HeaderText="Amount">
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:TextBox ID="txtTAmount" runat="server" Width="50px" Text='<%# Eval("Amount")%>'></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
 ...
 Enter Cash Received:
                ...
                <cc1:TabPanel runat="server" HeaderText="Administrative" ID="tpAdministrative" Visible="false">
                    ...
                    <ContentTemplate>--%>
                        ...
                        <asp:Panel ID="pnlAssignments" runat="server" Visible="true">
                            ...
                            <asp:Table runat="server">
                                ...
                                <asp:TableRow>
                                    <asp:TableCell ColumnSpan="5">
                                        <asp:Label runat="server" ID="lblFYIAssignments" Text="If you submit this as a new keyword, this is a sample of how possible conflicts will be assigned:"></asp:Label>
                                    </asp:TableCell>
                                </asp:TableRow>
                                <asp:TableRow>
                                        ...
                                        <asp:GridView ID="gvAssignUserConflicts" runat="server"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="OriginalType"
                                                    HeaderText="Type from WFAllActivity"></asp:BoundField>
                                            ...
                                            <asp:GridView ID="gvAssignments" runat="server"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Assigned To">
                                                        <ItemTemplate>
                                                            <asp:Panel CssClass="paneltest" Width="95%" runat="server">
                                                                <asp:Label ID="lblAssignedTo" runat="server" Text='<%# Bind("UserLogin")%>' Visible="false"></asp:Label>
                                                                <asp:Label ID="lblAssignedType" runat="server" Text='<%# Bind("Type")%>' Visible="false"></asp:Label>
                                                            </asp:Panel>
                                                    ...
                                                    <asp:TemplateField HeaderText="">
                                                        <ItemTemplate>
                                                            <asp:Panel runat="server">
                                                                <asp:LinkButton ID="btnRemoveAssignment" runat="server" Text='<%# Bind("Clicky")%>' CommandName="RemoveAssignation" CommandArgument='<%# Bind("Type")%>'></asp:LinkButton>
                                                            </asp:Panel>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                   ...
                   <%--                         <asp:ListItem Value="A" Text="Atlanta"></asp:ListItem>
                                            ...
                                            <asp:ListItem Value="GECC" Text="GECC"></asp:ListItem>
                                        </asp:DropDownList>
                                    </asp:TableCell>
                                    <asp:TableCell></asp:TableCell>
                                </asp:TableRow>
                                            ...
                                            <asp:GridView ID="gvAdminBankAcctNos" runat="server"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Facility">
                                                        <ItemTemplate>
                                                            <asp:Panel CssClass="paneltest" Width="95%" runat="server">
                                                                <asp:Label ID="lblFacility" runat="server" Text='<%# Bind("FacFull")%>' Visible="true"></asp:Label>
                                                            </asp:Panel>
                                                            <asp:DropDownList ID="ddlFacility" SelectedValue='<%# Bind("Facility")%>' runat="server" Visible="false">
                                                       <%--         <asp:ListItem Text="Atlanta" Value="A"></asp:ListItem>
                                                                <asp:ListItem Text="Cherokee" Value="C"></asp:ListItem>
                                                                <asp:ListItem Text="Duluth" Value="D"></asp:ListItem>
                                                                <asp:ListItem Text="Forsyth" Value="F"></asp:ListItem>
                                        ...
                                        <asp:Panel runat="server" ID="pnlSrchUser" Visible="false" BackColor="#CBE3FB">
                                            <asp:Table runat="server">
                                                <asp:TableRow>
                                                    ...
                                                    <asp:TableCell>
                                                        <asp:Button runat="server" ID="btnAdminUsrSrch" Text="Search" /></asp:TableCell>
                                                    <asp:TableCell>
                                                        <asp:LinkButton runat="server" ID="lbCloseUsrSrch" Font-Size="X-Small" Text="Close Search"></asp:LinkButton></asp:TableCell>
                                                    <asp:TableCell Width="5px"></asp:TableCell>
                                                </asp:TableRow>
                                                <asp:TableRow>

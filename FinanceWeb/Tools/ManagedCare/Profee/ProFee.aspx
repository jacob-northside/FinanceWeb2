...
<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="ProFee.aspx.vb" Inherits="FinanceWeb.ProFee"  %>
...
.modalBackground2 
{
  ...
  order by PayorName asc"
    ></asp:SqlDataSource>  
            ...
            ActiveTabIndex = "3" UseVerticalStripPlacement = "False" width="1150px" >
...
<%--    <asp:Label ID="Label1" runat = "server" Font-Bold = "true" Font-Size = "XX-Large" ForeColor = "#003060">
    ...
    <asp:DropDownList runat = "server" ID = "ddlSelectedFS" Font-Size = "small" DataTextField = "FeeSchedName" DataValueField = "FeeSchedName" AutoPostBack = "true" AppendDataBoundItems="False" Enabled="False">
    </asp:DropDownList>
...
create table #tempCat (rownumber int, TIN varchar(max))
    ...
    <asp:DropDownList runat = "server" ID = "ddlSelectedTINs" Font-Size = "small" DataTextField = "TIN" DataValueField = "rowlist" AutoPostBack = "true" AppendDataBoundItems="False" Enabled="False">
    </asp:DropDownList>
  ...
  and FeeSchedName = @FSName">
     ...
     <asp:GridView ID="GridView1" runat="server"  HeaderStyle-BackColor = "#4A8fd2" 
            ...
            RowStyle-HorizontalAlign = "Center" AllowPaging="False" HeaderStyle-Wrap="true" HeaderStyle-Font-Size="Small" 
    ...
    <asp:Table runat = "server" HorizontalAlign="Left" Width = "100%">
        <asp:TableRow> 
            <asp:TableCell VerticalAlign="Top">
                <asp:Table ID="Table2" runat = "server" CssClass="collapsetable" CellPadding="0" CellSpacing="0">
                    ...
                    <asp:TableRow>
                        ...
                        <asp:TableCell HorizontalAlign="Left" Font-Size = "small" Width="400px" >
            ...
            <%--When there's too much time on someone's hands, these checkboxes really ought to be auto-generated, because this setup is dumb--%>
                    ...
                    <asp:Table runat = "server">
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell Font-Size = "small" HorizontalAlign="Left">
                                ...
                                <asp:CheckBox ID="cbNCI" runat="server" Text="NCI" />
                            </asp:TableCell>
                        </asp:TableRow>
                <asp:TableRow><asp:TableCell Font-Size = "small" HorizontalAlign="Left">
            <asp:CheckBox ID="cbACC" runat="server" Text = "ACC"/></asp:TableCell>
                    <asp:TableCell Font-Size = "small" HorizontalAlign="Left">
<asp:CheckBox ID="cbNCPS" runat="server" Text = "NCPS"/>
                    </asp:TableCell></asp:TableRow>
                <asp:TableRow><asp:TableCell Font-Size = "small" HorizontalAlign="Left">
            <asp:CheckBox ID="cbAGA" runat="server" Text = "AGA"/></asp:TableCell>
                    <asp:TableCell Font-Size = "small" HorizontalAlign="Left">
                        <asp:CheckBox ID="cbNGDC" runat="server" Text="NGDC" />
                    </asp:TableCell></asp:TableRow>
                <asp:TableRow><asp:TableCell Font-Size = "small" HorizontalAlign="Left">
            <asp:CheckBox ID = "cbAJSS" runat = "server" Text = "AJSS" /></asp:TableCell>
                    <asp:TableCell Font-Size = "small" HorizontalAlign="Left">
                        <asp:CheckBox ID="cbNGSA" runat="server" Text="NGSA" />
            </asp:TableCell></asp:TableRow>
                <asp:TableRow><asp:TableCell Font-Size = "small" HorizontalAlign="Left">
            <asp:CheckBox ID = "cbGCS" runat = "server" Text = "GCS" /></asp:TableCell>
                    <asp:TableCell Font-Size = "small" HorizontalAlign="Left">
                        <asp:CheckBox ID="cbNPCPS" runat="server" Text="NPCPS" />
                        </asp:TableCell></asp:TableRow>
                <asp:TableRow><asp:TableCell Font-Size = "small" HorizontalAlign="Left">
            <asp:CheckBox ID = "cbGSPS" runat = "server" Text = "GSPS" /></asp:TableCell>        
                    <asp:TableCell Font-Size = "small" HorizontalAlign="Left">
                        <asp:CheckBox ID="cbNSPSex" runat="server" Text="NSPS (excl gyn onc)" />
                        </asp:TableCell></asp:TableRow>
                <asp:TableRow><asp:TableCell Font-Size = "small" HorizontalAlign="Left">
            <asp:CheckBox ID = "cbGU" runat = "server" Text = "GU" /></asp:TableCell>
                    <asp:TableCell Font-Size = "small" HorizontalAlign="Left">
                        <asp:CheckBox ID="cbNSPSonly" runat="server" Text="NSPS (gyn onc only)" />
                        </asp:TableCell></asp:TableRow>
                     <asp:TableRow><asp:TableCell Font-Size = "small" HorizontalAlign="Left">
            <asp:CheckBox ID = "cbMANG" runat = "server" Text = "MANG (All)" /></asp:TableCell>
                    <asp:TableCell Font-Size = "small" HorizontalAlign="Left">
                        <asp:CheckBox ID="cbNSPSinc" runat="server" Text="NSPS (incl gyn onc)" />
                        </asp:TableCell></asp:TableRow>
                <asp:TableRow><asp:TableCell Font-Size = "Small" HorizontalAlign = "Left">            
            <asp:CheckBox ID = "cbMANGPCP" runat = "server" Text = "MANG (PCP Only)" /></asp:TableCell>
                    <asp:TableCell Font-Size = "small" HorizontalAlign="Left">
                        <asp:CheckBox ID="cbPNFM" runat="server" Text="PNFM" />
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell Font-Size="small" HorizontalAlign="Left">
                                <asp:CheckBox ID="cbSEPC" runat="server" Text="SEPC" />
                        ...
                        <asp:TableRow>
                            <asp:TableCell Font-Size="small" HorizontalAlign="Left">
                                <asp:CheckBox ID="cbNAEC" runat="server" Text="NAEC/TEG" />
                            </asp:TableCell>
                            <asp:TableCell Font-Size="small" HorizontalAlign="Left">
                                <asp:CheckBox ID="cbUSA" runat="server" Text="USA" />
                            </asp:TableCell>

                        </asp:TableRow>
                        <asp:TableRow>
                            <asp:TableCell Font-Size="small" HorizontalAlign="Left">
                                <asp:CheckBox ID="cbNAPS" runat="server" Text="NAPS" />
                            </asp:TableCell>
                        </asp:TableRow>
...
<asp:Panel runat = "server" ScrollBars = "Auto"   BorderStyle="Solid" 
    ...
    <%-- <asp:Label runat = "server" ID = "labeltesting2"> </asp:Label>--%>
                     ...
                     <cc1:TabPanel Visible="false" runat = "server" HeaderText = "TIN Updates" ID = "tabProFeeTins">
                    <ContentTemplate>    
...
<%--     </div>--%>
  ...
  <%-- <div style="float: left; clear: both;"> --%>
   ...
   <cc1:ModalPopupExtender ID="ModalPopupExtender2" 
             ...
             DropShadow="true"/>
                     ...
                     <cc1:TabPanel Visible="false" runat = "server" HeaderText = "Galen Contract ID LU" ID = "GalenLU">
                    <ContentTemplate>    
  ...
  FROM DWH.Reference.ContractID_Profee_LU
  ...
  "
    ></asp:SqlDataSource> 
                         ...
                         <asp:Panel runat = "server" HorizontalAlign = "Right"> <asp:Button ID="lbOpenProFeeInst3" runat="server" Text="Open Instructions"  OnClientClick="open_win3()"  />
    ...
    Select INSPLAN_NAME:&nbsp;&nbsp;&nbsp;</asp:Label>
        ...
        <asp:DropDownList ID="ddlSelectedINSPLAN" runat="server" DataSourceID="dsINSPLANList" 
            ...
            <asp:listitem value="novalueselected">-- (optional) --</asp:listitem>
                                ...
                                <asp:TableCell></asp:TableCell>
                                <asp:TableCell HorizontalAlign="Right">
                                    <asp:Button runat="server" Text="Export Insplan List" ID="btnExportSTARINSPLANs" /><br />
                                </asp:TableCell>
                            </asp:TableRow>
                        </asp:Table>
...
<br />
   ...
   <cc1:ModalPopupExtender ID="ModalPopupExtenderGalen" 
          ...
          <asp:PostBackTrigger ControlID ="btnExportSTARINSPLANs" /> 
                       ...
                       <cc1:TabPanel runat = "server" HeaderText = "Galen STARINSPLAN" ID = "tpGalenUpdates">
                    <ContentTemplate>    
    ...
    SelectCommand="
           declare @Value varchar(max)
            ...
            Select Distinct [INSPLAN_NAME],0 as ord from (select @Value as [INSPLAN_NAME] from DWH.Reference.ContractID_Profee_LU ) s
    
    union
    
    SELECT DISTINCT [INSPLAN_NAME], 1 as ord
  FROM DWH.Reference.ContractID_Profee_LU
...
<%--                      <SelectParameters>
    ...
    SelectCommand="
            ...
            Select Distinct IDGroup from (select @Value as IDGroup from DWH.Reference.ContractID_Profee_LU ) s
  ...
  "
    >
                        ...
                        <asp:ControlParameter ControlID="ddlGalenUpdatesInpslanName" Name="InsplanName" 
                         ...
                         <asp:Panel runat = "server" HorizontalAlign = "Right"><asp:CheckBox runat="server" AutoPostBack="true" Visible="false" Text="Edit Insplans" ID="cbEditInsplans" />&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    Select IDGroup:&nbsp;&nbsp;&nbsp;</asp:Label></asp:TableCell><asp:TableCell>
        ...
        <asp:Panel runat = "server" ID = "pnlScrollPanelGalenUpdates" scrollbars = "auto" height = "800px" width = "95%">
                                  <asp:GridView ID="gvGalenUpdates" runat="server" AutoGenerateColumns="False" 
                                      DataKeyNames="INSPLAN,IDGroup,INSPLAN_NAME" 
...
<%--                                          <asp:BoundField DataField="DC_FROM" HeaderText="DC_FROM" ReadOnly="True" 
                                  ...
                                  <asp:SqlDataSource ID="dsGVGalenUpdates" runat="server" 
                                      ConnectionString="<%$ ConnectionStrings:PRDConn %>" SelectCommand="select * From DWH.Reference.ContractID_Profee_LU  
where (INSPLAN_NAME = @InsplanName or @InsplanName = ' -- (optional) -- ')

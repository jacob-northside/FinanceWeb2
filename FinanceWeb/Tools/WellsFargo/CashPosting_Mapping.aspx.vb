...
Public Class CashPosting_Mapping
    ...
    Private Sub loadddl()
        ...
        Dim ddlsql As String = "select distinct Bank_Account_Number, 1 as ord from DWH.UD.CashPosting_Mapping " & _
            "where ACTIVE_FLAG = 1 " & _
            "union select '(View All)', 0 " & _
            "order by ord "

        ddlBankAcctNo.DataSource = GetData(ddlsql)
        ddlBankAcctNo.DataTextField = "Bank_Account_Number"
        ddlBankAcctNo.DataValueField = "Bank_Account_Number"
        ddlBankAcctNo.DataBind()
    ...
    Private Sub loadgrid()
        ...
        Dim gridsql As String = "select * from DWH.UD.CashPosting_Mapping cm " & _
           "where Active_Flag = 1 "

        If ddlBankAcctNo.SelectedValue <> "(View All)" Then
            gridsql += " and BANK_ACCOUNT_NUMBER = '" & Replace(ddlBankAcctNo.SelectedValue, "'", "''") & "' "
        End If
    ...
    Private Sub ddlBankAcctNo_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ddlBankAcctNo.SelectedIndexChanged

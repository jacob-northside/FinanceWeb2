<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="FDLookupTables.aspx.vb" Inherits="FinanceWeb.FDLookupTables" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <asp:DropDownList ID="ddlLookUps" runat="server">
      ...
      <br />
      <br />
    <h5>  *To view data you must log in as a valid current Northside employee.
    </h5>

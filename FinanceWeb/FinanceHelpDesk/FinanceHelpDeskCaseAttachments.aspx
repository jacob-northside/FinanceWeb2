<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FinanceHelpDeskCaseAttachments.aspx.vb" Inherits="FinanceWeb.FinanceHelpDeskCaseAttachments" %>
...
<%--     <asp:ScriptManagerProxy ID="ScriptManagerProxy1" runat="server">
        ...
        <asp:ScriptManager ID="ScriptManager1" runat="server">
            ...
            ActiveTabIndex = "0" UseVerticalStripPlacement = "False"  >
                    <cc1:TabPanel runat = "server" HeaderText = "Finance Help Desk Attachments" ID = "tpMDPOSUnmapped" >
                    <ContentTemplate> 
...
<asp:GridView ID="gvImages" runat="server" AutoGenerateColumns="false" BackColor="#CBE3FB" AllowPaging="true" CellSpacing ="0" 
    ...
    <Columns>
        ...
        <asp:BoundField HeaderText="File Id" DataField="FileId" HeaderStyle-CssClass="hidden" />
